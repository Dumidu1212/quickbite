...
# Only internal services and admins that know the key can call this endpoint.
...
async def send_notification(
    ...
    """
    POST /notify/send
    Sends a direct email for testing and admin workflows.
    In production, most emails are triggered by Service Bus events.
    """
    # Reject requests without the correct internal key
    ...
    # send_generic_email is synchronous — no await needed
    # FastAPI runs sync functions in a thread pool executor automatically
